...
Config.ShowHistory = true          -- true == show vehicle history tab | false == hide vehicle history tab
Config.HistoryLimit = 10           -- Number of history entries to show per vehicle

-- Common ped models for garage attendants
Config.PedModels = {
    ['default'] = 's_m_m_autoshop_02',    -- Default garage attendant
    ['public'] = 's_m_m_autoshop_02',     -- Public garage attendant
    ['job'] = 's_m_y_airworker',          -- Job garage attendant
    ['gang'] = 'g_m_y_mexgoon_01',        -- Gang garage attendant
    ['depot'] = 's_m_m_security_01',      -- Depot attendant
    ['air'] = 's_m_y_pilot_01',           -- Airport attendant
    ['sea'] = 's_m_y_uscg_01',            -- Boat dock attendant
    ['police'] = 's_m_y_cop_01',          -- Police garage attendant
    ['ambulance'] = 's_m_m_paramedic_01', -- Ambulance garage attendant
    ['mechanic'] = 's_m_m_autoshop_01'    -- Mechanic garage attendant
}
...
Config.Garages = {
    motelgarage = {
        label = 'Motel Parking',
        takeVehicle = vector4(275.32, -345.53, 45.17, 342.56), -- Added heading
        pedModel = 's_m_m_autoshop_02', -- Specific ped model (optional, will use default if not specified)
        spawnPoint = {
    ...
    casinogarage = {
        ...
        takeVehicle = vector4(885.65, -2.19, 78.76, 163.02), -- Added heading
        pedModel = 's_m_y_valet_01', -- Casino valet
        spawnPoint = {
    ...
    sapcounsel = {
        ...
        takeVehicle = vector4(-330.01, -780.33, 33.96, 180.0), -- Added heading
        pedModel = 's_m_m_security_01', -- Security guard
        spawnPoint = {
    ...
    pillboxgarage = {
        ...
        takeVehicle = vector3(213.37, -809.86, 31.01),
        spawnPoint = {
